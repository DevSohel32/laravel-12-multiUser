    <div class="container mx-auto p-4">
        <div class="max-w-md mx-auto mt-10">
            ...
            <form method="POST" action="{{ route('admin_login_submit') }}" class="bg-white p-6 rounded border border-gray-300">
                @csrf
                ...
                <div class="mt-4">
                    <a href="{{ route('admin_forgot_password') }}" class="text-blue-500 hover:text-blue-700 text-sm">Forgot Password?</a>
                </div>
            </form>
        </div>
    </div>
